...
<body>
                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="Accueil">Trouver un service </a></li>
   ...
   echo" <div class='alert alert-warning alert-dismissible fade show' role='alert'>
                <strong>Message envoyé avec succes</strong> 
   ...
   <br>
                <div class="row">
                    ...
                    <div class="col-lg-8">
                    <form action="sendmail.php" method="POST"  class="register-form" id="register-form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12">
