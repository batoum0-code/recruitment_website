<?php
    ...
    }else
    {
     ...
     {
        $nom1 = $_POST['nom'];
        $sql = "select * from localisation where Ville like '$nom1%' ";         
...
<form method="post" action="Localisation.php">
     <ul>
  ...
  <div class="container">
    ...
    <center><div  class="panel-heading" style=" display: inline-block;width: 500px;height: 100px;color:white; font-size:xx-large;">Liste des Villes</div></center>
  
    <form method="get" action="modifierLocalisation.php">
    <div class="panel panel-primary margetop">
    <div class="panel-body">
         <a href="AjoutLocalisation.php"style=" margin-left: 88%;" >Ajout</a>
        ...
        <tbody>
            ...
            <td>
             <a href="modifierLocalisation.php?idcl=<?php echo $Row['Idl']?>" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
             <a onclick="return confirm('Etes vous sûr de vouloir Supprimer Ville ? ')" href="supprimerLocalisation.php?idcl=<?php echo $Row['Idl'] ?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
