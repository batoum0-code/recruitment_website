<?php
  ...
  if(!isset($_SESSION["page"]))
    ...
    }else
    {
     ...
     {
        $nom1 = $_POST['nom'];
            $sql = "select * from client where Nom like '$nom1%' or Prenom like '$nom1%'";         
...
<form method="post" action="Admin.php">
    ...
    <li>
        <button type="button" onclick="window.location.href='Admin.php';" style="background-color:#666; margin-left: 50px; margin-top: 8px;">Clients</button>
    </li>
    <li>
  ...
  <div class="container">
       ...
       <div class="panel panel-success margetop"> <center><div  class="panel-heading" style=" display: inline-block;width: 500px;height: 100px;color:white; font-size:xx-large;">Liste des Clients</div></center>
  
    <form method="get" action="modifieremployes.php">
    <div class="panel panel-primary margetop">
    <div class="panel-body">
         <a href="AjoutAdminClient.php"style=" margin-left: 93%;" >Ajout</a>
        ...
        <tbody>
            ...
            <tr class=lignecolor>
            <td><img style="width:80px;height:80px;border-radius:500px;" src="images/<?php echo $Row['ImgP']?>"/></td>
            ...
            <td>
             <a href="modifierClient.php?idcl=<?php echo $Row['Cin']?>" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
             <a onclick="return confirm('Etes vous sûr de vouloir Supprimer Client ? ')" href="supprimerClient.php?idcl=<?php echo $Row['Cin'] ?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
             <a href="activerClient.php?idcl=<?php echo $Row['Cin']?>&etat=<?php echo $Row['act']?>">
            <?php
                if ($Row['act']==0) {?>
