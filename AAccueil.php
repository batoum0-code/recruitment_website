...
<html class="no-js" lang="zxx">
   ...
   <body>
                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="Accueil.php">Find service </a></li>
    ...
    <div class="p-2 bd-highlight">
    	 <select  id="prof" name="prof" class="round" style="background-color:#666; margin-top: 20px; margin-left: 320px;">
         <?php
                       ...
                       echo"
                           ...
                           <div class='job-tittle'>
                               ...
                               <li ><i class='fa fa-user'></i>$Prenom  $Nom</li>
                                   <li>$Idre</li>
                                   <li><i class='fas fa-map-marker-alt'></i>$Idre $Idv</li>
                                   <li>$Tel</li>
                               </ul>
                           </div>
                       </div>
