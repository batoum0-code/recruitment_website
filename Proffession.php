<?php
  ...
  if(!isset($_SESSION["page"]))
    ...
    }else
    {
     ...
     {
        $nom1 = $_POST['nom'];
        $sql = "select * from proffession where Prof like '$nom1%' ";         
...
<form method="post" action="Proffession.php">
     <ul>
  ...
  <div class="container">
    ...
    <center><div  class="panel-heading" style=" display: inline-block;width: 500px;height: 100px;color:white; font-size:xx-large;">Liste des Proffessions</div></center>
  
    <form method="get" action="modifierProffession.php">
    <div class="panel panel-primary margetop">
    <div class="panel-body">
         <a href="AjoutProffession.php"style=" margin-left: 78%;" >Ajout</a>
        ...
        <tbody>
            ...
            <td>
             <a href="modifierProffession.php?idcl=<?php echo $Row['Idp']?>" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
             <a onclick="return confirm('Etes vous sûr de vouloir Supprimer Proffession ? ')" href="supprimerProffession.php?idcl=<?php echo $Row['Idp'] ?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
